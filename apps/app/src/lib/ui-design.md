...
This guide explains how to design user interfaces for the R1 device's 240x282px webview screen. The design philosophy emphasizes simplicity, large touch targets, and viewport-relative sizing.
...
.container {
  width: 100vw;
  height: 117.5vw;      /* 282px height on 240px width */
  background: #000000;
  padding: 3.33vw;
...
1. Test on the 240×282px R1 webview
